(function(window, document) {
	...
	SliderBar.prototype = {
		...
		reToNewImg: function() {
			...
			var imgSrc = "./img/npuzzle/" + _this.imgList[index] + "";
		...
		mousedown: function(_this, e) {
			...
			function mouseup() {
				...
				var judgeThreshold = 4;
				if(_this.resultX > (left - judgeThreshold) && _this.resultX < (left + judgeThreshold)) {
					_this.isSuccess = true;
